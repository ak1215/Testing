...
public class AuctionController {
    ...
    @GetMapping("/auctions/between/{maxPrice}/{minPrice}")
    public ResponseEntity<Void> getAuctionByRange (@PathVariable int minPrice, @PathVariable int maxPrice){
        auctionService.getAuctionByRange(minPrice, maxPrice);
